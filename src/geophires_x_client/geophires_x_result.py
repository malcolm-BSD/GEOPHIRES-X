    ...
    _RESULT_FIELDS_BY_CATEGORY = MappingProxyType(
        {
            ...
            "DISPATCH RESULTS": [
                ...
                "TESS minimum SOC",
                "TESS maximum SOC",
                "TESS final temperature",
                "TESS annual charge",
                "TESS annual discharge",
                "TESS annual standby loss",
                "TESS annual efficiency loss",
                "TESS curtailed geothermal heat",
                "TESS equivalent full cycles",
                "Peak customer demand",
                "Peak geothermal charge",
                "Customer demand standard deviation",
                "Geothermal output standard deviation",
                "Geothermal output smoothing ratio",
