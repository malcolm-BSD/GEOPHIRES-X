...
from geophires_x.levelized_costs import build_levelized_cost_bases
from geophires_x.Model import Model
from geophires_x.Units import CO2ProductionUnit
...
from geophires_x.xlco import CommodityBenefitStreams
...
class XLCOETestCase(BaseTestCase):
    ...
    def test_xlcoe_parameters_and_outputs_are_defined(self):
        ...
        self.assertIn("Do XLCO(E|H|C) Calculations", model.economics.ParameterDict)
        self.assertIn("Social Discount Rate", model.economics.ParameterDict)
        self.assertIn("XLCOE Avoided Emissions Intensity", model.economics.ParameterDict)
        self.assertIn("XLCO(E|H|C) Carbon Price", model.economics.ParameterDict)
        ...
        self.assertIn("XLCO(E|H|C) Water Shadow Price", model.economics.ParameterDict)
        self.assertIn("Idle Rig Discount Rate", model.economics.ParameterDict)
        self.assertIn("XLCO(E|H|C) Construction Jobs Per Rig", model.economics.ParameterDict)
        self.assertIn("XLCO(E|H|C) Operations Jobs Per MW", model.economics.ParameterDict)
        self.assertIn("XLCO(E|H|C) Indirect Jobs Multiplier", model.economics.ParameterDict)
        self.assertIn("XLCO(E|H|C) Average Monthly Wage", model.economics.ParameterDict)
        self.assertIn("XLCOH Avoided Emissions Intensity", model.economics.ParameterDict)
        self.assertIn("XLCO(E|H|C) Carbon Price", model.economics.ParameterDict)
        self.assertIn("XLCOH Thermal REC", model.economics.ParameterDict)
        ...
        self.assertIn("XLCO(E|H|C) Carbon Price", model.economics.ParameterDict)
        self.assertIn("XLCOC Thermal REC", model.economics.ParameterDict)
        ...
        self.assertFalse(model.economics.DoXLCOCalculations.value)
        self.assertEqual(0.07, model.economics.social_discountrate.value)
        self.assertEqual(0.0, model.economics.XLCOEAvoidedEmissionsIntensity.value)
        self.assertEqual(0.0, model.economics.XLCOCarbonPrice.value)
        ...
        self.assertEqual(0.0, model.economics.XLCOWaterShadowPrice.value)
        self.assertEqual(0.0, model.economics.IdleRigDiscountRate.value)
        self.assertEqual(0.0, model.economics.XLCOConstructionJobsPerRig.value)
        self.assertEqual(0.0, model.economics.XLCOOperationsJobsPerMW.value)
        self.assertEqual(1.0, model.economics.XLCOIndirectJobsMultiplier.value)
        self.assertEqual(0.0, model.economics.XLCOAverageMonthlyWage.value)
        self.assertEqual(0.0, model.economics.XLCOHAvoidedEmissionsIntensity.value)
        self.assertEqual(0.0, model.economics.XLCOHREC.value)
        ...
        self.assertEqual(0.0, model.economics.XLCOCREC.value)
        ...
        self.assertEqual(CostPerMassUnit.DOLLARSPERTONNE, model.economics.XLCOCarbonPrice.CurrentUnits)
        self.assertEqual(EnergyCostUnit.DOLLARSPERMWH, model.economics.XLCOHREC.CurrentUnits)
        self.assertEqual(CurrencyUnit.DOLLARS, model.economics.XLCOWaterShadowPrice.CurrentUnits)
        self.assertEqual(CO2ProductionUnit.TONNEPERMWH, model.economics.XLCOCAvoidedEmissionsIntensity.CurrentUnits)
        self.assertEqual(EnergyCostUnit.DOLLARSPERMWH, model.economics.XLCOCREC.CurrentUnits)
    ...
    def test_xlcoe_disabled_leaves_lcoe_unchanged_and_outputs_zero(self):
        ...
        disabled_model = self._new_model(
            input_file=Path(self._get_test_file_path("../examples/Fervo_Project_Cape-5.txt")),
            additional_params={"Do XLCO(E|H|C) Calculations": False},
            read_and_calculate=True,
        )
    ...
    def test_xlcoe_enabled_with_zero_market_inputs_matches_lcoe(self):
        model = self._new_model(
            ...
            additional_params={"Do XLCO(E|H|C) Calculations": True},
            read_and_calculate=True,
        )
    ...
    def test_xlcoe_social_benefits_reduce_market_social_breakeven_price(self):
        ...
        social_model = self._new_model(
            ...
            additional_params={
                ...
                "XLCO(E|H|C) Water Shadow Price": 0.25,
                "XLCO(E|H|C) Construction Jobs Per Rig": 37.0,
                "XLCO(E|H|C) Operations Jobs Per MW": 1.7,
                "XLCO(E|H|C) Indirect Jobs Multiplier": 1.0,
        ...
        self.assertAlmostEqual(
            social_model.economics.XLCOE_Market.value, market_model.economics.XLCOE_Market.value, places=7
        )
        self.assertLess(
    ...
    def test_xlcoc_social_benefits_reduce_market_social_breakeven_price(self):
        ...
        social_model = self._new_model(
            ...
            additional_params={
                ...
                "XLCO(E|H|C) Water Shadow Price": 0.4,
                "XLCO(E|H|C) Operations Jobs Per MW": 1.1,
                "XLCO(E|H|C) Indirect Jobs Multiplier": 1.0,
                "XLCO(E|H|C) Average Monthly Wage": 4000.0,
            },
            read_and_calculate=True,
        ...
        self.assertAlmostEqual(
            social_model.economics.XLCOC_Market.value, market_model.economics.XLCOC_Market.value, places=7
        )
        self.assertLess(
    ...
    def test_cogeneration_construction_jobs_benefit_is_allocated_by_baseline_cost_share(self):
        ...
        construction_jobs_total = (
            total_wells
            * benefit_model.economics.XLCOConstructionJobsPerRig.value
            * benefit_model.economics.XLCOIndirectJobsMultiplier.value
        )
        annual_construction_jobs_musd = (
            construction_jobs_total
            * benefit_model.economics.XLCOAverageMonthlyWage.value
            * 12.0
            / construction_years
            / 1_000_000.0
        )
        ...
        self.assertAlmostEqual(
            total_shared_social_benefit
            * bases[ELECTRICITY_COMMODITY].baseline_discounted_cost_musd
    ...
    def _observed_discounted_benefit_musd(basis, baseline_public_value: float, benefit_public_value: float) -> float:
        return (baseline_public_value - benefit_public_value) * basis.discounted_output / basis.public_price_factor
